...
:: Android packaging
set AND_CERT_NAME="CityGame2013"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\CityGame2013.p12
...
set IOS_PROVISION=cert\CityGame2013.mobileprovision
...
set APP_ID=air.fr.citygame.un.CityGame2013
